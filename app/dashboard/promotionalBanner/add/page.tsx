...
const BannerForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    createBanner(e, file, bannerName, description);
  };
      ...
      <div className="p-4 pb-8 border-b border-t border-bgRed flex gap-4">
        <form onSubmit={handleSubmit} encType="multipart/form-data" className="flex flex-col gap-6 w-full">
          <div className="flex flex-col gap-2">
            <label className="block font-medium leading-6 text-gray-900">Banner Name</label>
            <input
              type="text"
              id="banner_name"
              value={bannerName}
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="description" className="block font-medium leading-6 text-gray-900">Description</label>
            <textarea
              rows={3}
              name="description"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="description" className="block font-medium leading-6 text-gray-900">Image</label>
            <input
